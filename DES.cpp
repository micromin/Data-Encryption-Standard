 ...
 * 
 * Fork from ammosh/Data-Encryption-Standard (https://github.com/ammosh/Data-Encryption-Standard)
 * 
...
int main()
{
    ...
    cout << "Fork from ammosh/Data-Encryption-Standard (https://github.com/ammosh/Data-Encryption-Standard)" << endl << endl;
